...
A consolidated archive of all documentation, implementations, and reference materials for **Aelaki** -- a constructed language (conlang) designed for a science fiction setting on a ringworld called Ngorno.
